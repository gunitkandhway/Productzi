...
const Shop: React.FC = () => {
  ...
  return (
    <div className="shop-container">
      <h2 className="shop-title">TechHub Shop</h2>
      ...
      >
        ...
        <div className="cart-items">
          {cart.map((item: Product) => (
            <div key={item.id} className="cart-item">
              <img src={item.images[0] || "/placeholder.svg"} alt={item.title} className="cart-item-image" />
        ...
        {cart.length === 0 && <p className="empty-cart-message">Your TechCart is empty</p>}

        <div className="modal-footer">
          <button onClick={() => setModalIsOpen(false)} className="continue-shopping-btn">
            Continue Shopping
          </button>
      ...
      <div className="product-grid">
        {products.map((product) => (
          <div key={product.id} className="product-card">
            <img src={product.images[0] || "/placeholder.svg"} alt={product.title} className="product-image" />
